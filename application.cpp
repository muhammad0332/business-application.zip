...
void addbook()
{
    ...
    while(!(cin >> bookprice[idxbook]) || bookprice[idxbook]<0)
    {
        isnotvalid();
    }
    cout << "Enter the quantity of book: ";
    while(!(cin >> bookquantity[idxbook]))
    {
        isnotvalid();
    }
    cout << "Enter the sale of book: ";
        while(!(cin >> salebook[idxbook]))
    {
        isnotvalid();
    }
    SetConsoleTextAttribute(h, 15);
...
void addfood()
{
    ...
    cout << "Enter the price of food: ";
       while(!(cin >> foodprice[idxfood]) ||foodprice[idxfood]<0)
    {
        isnotvalid();
    }
    cout << "Enter the quantity of food: ";
        while(!(cin >>foodquantity[idxfood]) || foodquantity[idxfood]<0)
    {
        isnotvalid();
    }
    cout << "Enter the sale of food: ";
    while(!(cin >>salefood[idxfood]) || salefood[idxfood]<0)
    {
        isnotvalid();
    }
    SetConsoleTextAttribute(h, 15);
...
void addelectronic()
{
    ...
    while (!(cin >> electronicprice[idxelectronic]) || electronicprice[idxelectronic]<0)
    {
        isnotvalid();
    }
    cout << "Enter the quantity of electric: ";
    while (!(cin >> electronicquantity[idxelectronic]) || electronicquantity[idxelectronic]<0)
    {
        isnotvalid();
    }
    cout << "Enter the sale of electric: ";
    while (!(cin >> saleelectronic[idxelectronic]) || saleelectronic[idxelectronic]<0)
    {
        isnotvalid();
    }
        SetConsoleTextAttribute(h, 15);
...
void isnotvalid()
{
    cout << "error: enter a wrong number";
    cin.clear();
    cin.ignore(123, '\n');
}
